    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Berkas Perkara</span>
            </a>
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="/admin/datapeminjam" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="/admin/databerkas" class="nav-link">
                        ...
                        <li class="nav-item menu-close">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="/hotspot/user" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>User</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/hotspot/user-profiles" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>User Profiles</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/hotspot/hosts" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Host</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/hotspot/ipbindings" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>IP Bindings</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            <a href="/hotspot/guest" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>
                                    Haldin Guest User
                                    <!-- <span class="right badge badge-danger">New</span> -->
